...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color: #457B8B;width: 100%; " >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active">
                <button class="btn btn-outline-dark" id="syl1" type="button"><a href="" style="text-decoration: none; color: white;">Services</a></button>
            </li>
            <li class="nav-item active">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: rgb(197, 191, 191); margin-left: 35px; ">
                    <a class="dropdown-item" style="color: black; " href="index1.php">Login</a>
        ...
        <div class="row" >
          ...
          <div class="col-sm-12 col-md-2">
            ...
            <form method="POST" action="logincheck.php">
									<input type="email" name="email" placeholder="Enter email" class="form-control" style="width:170px; margin:auto; text-align: center;" required/><br/>
                  <input type="password" name="password" placeholder="Enter password"  class="form-control"  style="width:170px; margin:auto; text-align: center;"required/><br/>
    ...
    <div id="box5"> 
      <a href="www.google.com" style="color: white; font-size: 1.3vw;">About Us</a>
      <a href="www.google.com" style="color: white; margin-left: 60px; font-size: 1.3vw;">Terms & condition</a>
      <a href="www.google.com" style="color: white; margin-left: 60px; font-size: 1.3vw;">Privacy Policy</a>
      <a href="https://www.google.com" style="color: white; margin-left: 60px; font-size: 1.3vw;">Help</a>
    </div>
